...
const ItemDetail = ({ product }) => {
  ...
  const onAdd = (cantidad) => console.log("Cantidad del producto seleccionados: "+cantidad)
    ...
    <div className="row ms-5 d-flex justify-content-center" style={{marginTop: 200}}>
       <div className="col-3 d-flex justify-content-center flex-wrap">
        <div className="card-header">
          <p className="text-white fs-3 al-center d-flex justify-content-center">{product.name}</p> 
        </div>
